...
const pages: StaticPage[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "추모 대행은 헌화, 잔디 정돈, 사진 회신까지를 한 세트로 드립니다. 분양(자리 안내)과 달리, 이미 모신 자리에 대한 마음 서비스입니다. 현장에서 촬영한 묘역 사진은 사이버 추모관 타임라인에 자동 연동됩니다.",
      },
      {
        type: "list",
        items: ["기일·한식·추석 대행", "헌화 + 묘역 사진 전송", "연간 정기 추모 계약", "사이버 추모관 묘역 사진 연동"],
      },
      {
        type: "cta",
        links: [
          { href: "/memorial", label: "사이버 추모관", primary: true },
